...
```
git clone https://gitflic.ru/project/oleg_igorich/complementer_catalog.git
cd complementer_catalog
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/oleg_igorich/complementer_catalog.git
git clone
